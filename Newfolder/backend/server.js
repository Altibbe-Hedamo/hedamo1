...
app.put('/api/profiles/user', authenticateToken, checkAccess(['agent', 'employee', 'client', 'hap']), async (req, res) => {
  try {
    ...
    // Frontend now sends data in the correct database field format

    // Build update data using the direct field names from frontend (new format)
    const updateData = {
      full_name: req.body.full_name || currentProfile.full_name,
      date_of_birth: req.body.date_of_birth || currentProfile.date_of_birth,
      ...
      permanent_address: req.body.permanent_address || req.body.current_address || currentProfile.permanent_address,
      id_number: req.body.id_number || currentProfile.id_number,
      ...
      years_of_experience: req.body.years_of_experience ? parseInt(req.body.years_of_experience) : currentProfile.years_of_experience,
      ...
      photo_path: req.body.photo_path || currentProfile.photo_path,
      selfie_path: req.body.selfie_path || currentProfile.selfie_path,
      cancelled_cheque_path: req.body.cancelled_cheque_path || currentProfile.cancelled_cheque_path,
      criminal_record: req.body.criminal_record || currentProfile.criminal_record,
      criminal_details: currentProfile.criminal_details,
      conflict_of_interest: currentProfile.conflict_of_interest,
      accept_code_of_conduct: req.body.accept_code_of_conduct !== undefined ? req.body.accept_code_of_conduct : currentProfile.accept_code_of_conduct,
      training_willingness: req.body.training_willingness || currentProfile.training_willingness,
      training_mode: currentProfile.training_mode,
      resume_path: req.body.resume_path || currentProfile.resume_path,
