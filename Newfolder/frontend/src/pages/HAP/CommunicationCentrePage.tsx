  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      try {
        ...
        const response = await api.get('/api/hap/announcements', {
          headers: {
        ...
        if (err.response) {
          if (err.response.status === 403) {
            setError('Access denied. You must be a HAP to view these announcements.');
          } else {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-600">Stay updated with the latest announcements from admin</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Latest Announcement</p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            {announcements.length > 0 ? (
              ...
              <p className="text-gray-500 text-center py-4">No announcements available at the moment.</p>
            )}
          </div>
        </div>
      </div>
