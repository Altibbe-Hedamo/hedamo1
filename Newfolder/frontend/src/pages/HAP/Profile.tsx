...
const Profile: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <svg className="animate-spin h-8 w-8 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8h8a8 0 01-8 8 8 8 0 01-8-8z"></path>
        </svg>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto min-h-screen bg-gray-50">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">HAP Profile</h1>
      {error && (
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex items-center mb-8">
          ...
          />
          <div>
            <h2 className="text-2xl font-semibold text-gray-800">{profile.full_name || 'HAP Name'}</h2>
        ...
        <button
          onClick={() => navigate('/hap-portal/edit-profile')}
