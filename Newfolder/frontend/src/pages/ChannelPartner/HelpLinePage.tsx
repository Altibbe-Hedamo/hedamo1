      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            We're here to help you with any questions or concerns about HVP services
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">HVP Support Center, Gachibowli, Hyderabad, Telangana - 500032</p>
          ...
          <div className="mt-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600">
              <li>Please have your channel partner ID ready when contacting support</li>
