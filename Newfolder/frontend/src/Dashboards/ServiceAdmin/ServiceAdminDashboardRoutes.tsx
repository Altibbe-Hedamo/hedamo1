...
const ProtectedRoute: React.FC<{ children: JSX.Element }> = ({ children }) => {
  ...
  return user && user.type === 'serviceadmin' ? children : <Navigate to="/login" replace />;
};

const ServiceAdminDashboardRoutes = () => {
  return (
    <div className="flex bg-gray-50 min-h-screen">
      <Sidebar />
      <div className="flex-1 p-8">
        <Routes>
          <Route path="/" element={<Navigate to="/service-admin-dashboard/dashboard" replace />} />
...
export default ServiceAdminDashboardRoutes; 